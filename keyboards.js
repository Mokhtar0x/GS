...
const keyboards = {
    ...
    // Main user keyboards - Arabic with referral
    userKeyboardAr: {
        reply_markup: {
            keyboard: [
                [{ text: '📋 المهام' }],
                [{ text: '💰 المحفظة' }, { text: '💳 السحب' }],
                [{ text: '⏳ الأموال المعلقة' }, { text: '🔗 الإحالة' }],
                [{ text: '🆔 عرض الآيدي' }],
                [{ text: '💬 الدعم' }]
            ],
            resize_keyboard: true,
    ...
    bulkEmailManagementAr: {
        reply_markup: {
            keyboard: [
                ...
                [{ text: '➕ إضافة لقائمة التصدير' }],
                [{ text: '➖ حذف من قائمة التصدير' }],
    ...
    bulkEmailManagementEn: {
        reply_markup: {
            keyboard: [
                ...
                [{ text: '➕ Add to Export List' }],
                [{ text: '➖ Remove from Export List' }],
